   ...
   public function formatDate($date, $oldFormat, $newFormat)
    ...
    public function addMerchant($data)
    {
        try {
            ...
            if($merchant){
            return $this->fail(true, "Merchant already exist!", '', 400);
            }
            ...
            return $this->success(false, "Merchant successfully added!", $merchant, 200);

        } catch (Exception $e) {
            return $this->fail(true, "Couldn't add merchant!", $e->getMessage(), 400);
        }
    }
}
